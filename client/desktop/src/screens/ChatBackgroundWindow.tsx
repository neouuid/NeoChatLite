...
export const ChatBackgroundWindow: React.FC<ChatBackgroundWindowProps> = ({ onBack }) => {
  ...
  const presetImageBackgrounds = [
    { id: 'bg1', label: '渐变一', gradient: ['#667eea', '#764ba2'] },
    { id: 'bg2', label: '渐变二', gradient: ['#11998e', '#38ef7d'] },
    { id: 'bg3', label: '渐变三', gradient: ['#f093fb', '#f5576c'] },
    { id: 'bg4', label: '渐变四', gradient: ['#fa709a', '#fee140'] },
    { id: 'bg5', label: '渐变五', gradient: ['#a18cd1', '#fbc2eb'] },
    { id: 'bg6', label: '渐变六', gradient: ['#4facfe', '#00f2fe'] },
  ];
